...
<head>
    ...
    <link href="{{ asset('css/info-styles.css') }}" rel="stylesheet" />
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#!">Start Bootstra</a>
            ...
            <div class="col-lg-8">
                ...
                <article>
                    ...
                    <header class="mb-4">
                        ...
                        <!-- Post meta content-->
                        <div class="text-muted fst-italic mb-2">Posted on January</div>
                        <!-- Post categories-->

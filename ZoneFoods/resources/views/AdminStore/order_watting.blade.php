...
<body id="page-top">
                            ...
                            <table class="table table-bordered table-hover" style="margin-top: 20px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50px">
                                            @if($order->status == 0)
                                            <button class="btn btn-warning" onclick="duyet({{$order->id}},1)">Duyệt
                                            </button><br>
                                            <button class="btn btn-warning"
                                                onclick="duyet({{$order->id}},2)">Hủy</button>
                                            @endif
                                        </td>
                                        <td style="width: 50px">
                                            <a href="{{route('Order.orderDetail',['id'=>$order->id])}}">Chi tiết</a>
                                        </td>
    ...
    <script>
    function duyet(id, cong) {
        console.log(id, cong);

        var _csrf = '{{csrf_token()}}';
        let content_url = '{{route("ajax.action")}}';

        console.log(id, content_url, _csrf);
        $.ajax({
            url: content_url,
            type: 'POST',
            data: {

...
<head>
    ...
    <title>Sản phẩm của ZoneFood</title>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endforeach
                            <td>{{$Food->name}}</td>
                            <td>{{$Food->product_category->name}}</td>
                            <td>{{$Food->description}}</td>
                            <td>{{$Food->discount}}đ</td>
                            <td>{{$Food->product_store->name}}</td>
                            <td>
                                <a href="Master-DeleFood/{{$Food->id}}" onclick="return remove(this);"
                                    value="{{$Food->id}}" name="{{$Food->name}}" class="btn"
                                    style="color:red; background-color: #CCCCFF;">
                                    <i class="fa fa-trash"></i>
                                </a>

                                <a href="Master-EditFood/{{$Food->id}}" class="btn"
...
@if(session('message') == "xoa sp")
<script type="text/javascript">
$(document).ready(function() {
    demo.ShowMasterDeleteFood();
});
</script>
@endif

...
<head>
    ...
    <title>Khách Hàng của ZoneFood</title>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Master-DeleUser/{{$User->id}}" onclick="return remove(this);"
                                    value="{{$User->id}}" name="{{$User->name}}" class="btn"
                                    style="color:red; background-color: #CCCCFF;">
                                    <i class="fa fa-trash"></i>
                                </a>

                                <a href="Master-EditUser/{{$User->id}}" class=" btn"
...
@if(session('message') == "xoa us")
<script type="text/javascript">
$(document).ready(function() {
    demo.ShowMasterDeleteUser();
});
</script>
@endif

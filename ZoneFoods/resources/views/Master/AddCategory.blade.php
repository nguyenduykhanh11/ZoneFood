...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <!-- End Navbar -->
            <div>
                <form action="/Master-AddCategoryDone" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img class="img-account-profile mb-2" src="" width="200px" alt="">
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">Thêm loại mới</div>
                                    <div class="card-body">
                                        ...
                                        <!-- Form Row-->
                                        <!-- Save changes button-->
                                        <button class="btn btn-primary" type="submit">Thêm Loại</button>
                                        @csrf
                </form>
            </div>
        </div>
...
<script>
function question() {
    var ans = confirm("bạn muốn thêm loại mới ?");
    return ans;
}
...
@if(session('message') == "add cate")
<script type="text/javascript">
$(document).ready(function() {
    demo.ShowMasterAddCategory();
});
</script>
@endif

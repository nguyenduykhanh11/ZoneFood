		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="/ok" method="GET" name="loginForm" class="signin-form">
		      		<div class="form-group">
		      			<input type="Email" class="form-control" placeholder="Email của bạn" name="mail_name" autocomplete="new-Username" required>
		      		</div>
	            <div class="form-group">
	          ...
	          <div class="social d-flex text-center">
	          	<a href="/sms_view" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span>Số điện thoại</a>
	          </div>
		      </div>
				</div>
			</div>
